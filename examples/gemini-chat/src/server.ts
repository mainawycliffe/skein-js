// Serve this example's `langgraph.json` (the Gemini ReAct `gemini` graph) over HTTP with
// @skein-js/express. This is the programmatic equivalent of what `skein dev` boots in process. Run
// it directly with `tsx src/server.ts` (PORT overridable), or import `startServer` in a test to
